# Import necessary libraries and suppress TensorFlow logs
import os
...
# Load MNIST dataset and filter for digit 7
...
# Ensure buffer size is a multiple of batch size
...
# Create training dataset using TensorFlow Dataset API
train_dataset = tf.data.Dataset.from_tensor_slices(x_train).shuffle(BUFFER_SIZE).batch(BATCH_SIZE)

# Set hidden dimension for latent space
hidden_dim = 2
...
# Define training step function using TensorFlow's autograd mechanism
@tf.function
